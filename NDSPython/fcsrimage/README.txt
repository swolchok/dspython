This is not finished yet. Please don't bug me about it. - davr http://blog.davr.org/

* You must build 'zero' and 'bless' from the corresponding .cpp files.
* Either need sudo installed, or run the build script as root
